...
![image-20221209081200993](OLED设备组件.assets/image-20221209081200993.png)

![image-20221209081129965](OLED设备组件.assets/image-20221209081129965.png)
...
* 如果 Co 位设置为逻辑 “0”，则此后通过 I2C 传输的信息全部为数据字节，即不需要再发送控制字节。
...
5. I2C 通信异常中断后（如异常终止 Debug、烧录代码等）将不能恢复正常工作，请重启电源。
