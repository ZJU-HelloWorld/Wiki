...
```cpp
//在ins_motor.cpp中
hw_motor::DM_J4310 unique_motor(1, optional_params);
hw_motor::Motor *CreateMotor(void) { return &unique_motor; }

//在comm_task.cpp中
fdcan1_rx_mgr_ptr->addReceiver(CreateMotor());
fdcan1_tx_mgr_ptr->addTransmitter(CreateMotor());
```
...
### [下载中心-上海瓴控科技有限公司](http://www.lkmotor.cn/Download.aspx?ClassID=21)
