...
$$
\hat k_{M}\sum_j \Omega_j \cdot K_{p_j}( k_1\cdot k_{0_j} \Omega_{ref_j}-\Omega_j)+
\sum_j 
\hat R \cdot K_{p_j}^2 (k_1 \cdot k_{0_j}\Omega_{ref_j}-\Omega_j)^2
+P_0 \triangleq P_{ref}
$$
...
$$
\begin{split}
\alpha = &\hat R K_{p_j}^2 \sum_j k_{0_j}^2 \Omega_{ref_j}^2\\
\beta = & (\hat k_{M}K_{p_j}-2\hat RK_{p_j}^2 )\sum_j k_{0_j}\Omega_j\Omega_{ref_j}\\
\gamma= & (\hat RK_{p_j}^2-\hat k_{M}K_{p_j}) \sum_j \Omega_j^2+P_0-P_{ref}\\
\end{split}
$$
